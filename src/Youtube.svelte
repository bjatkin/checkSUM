    ...
    {#if !user.firstpage}
        <div class="parent">
            ...
            <div class="center" style="height: 110px;">
                ...
                <div style="margin-top: 10px; float: right; width: 50%;">
                ...
                <div style="margin-top: 10px; padding-top: 12px;">
                    <svg style="width:175px; height: 50px;" viewBox="0 0 210 60">
                        <g id="layer1">
                            ...
                            <path
                            id="rect887"
                            style="fill:#fff;fill-opacity:1;stroke:none;stroke-width:0.144273;stroke-opacity:1"
                            ...
                            <path
                            id="circle954"
                            style="fill:#fff;fill-opacity:1;stroke:none;stroke-width:0.172211;stroke-opacity:1"
